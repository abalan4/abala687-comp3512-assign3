  <div class="mdl-layout__drawer mdl-color--blue-grey-800 mdl-color-text--blue-grey-50">
       <div class="profile">
           ...
           <h4>Alex Balan</h4>           
           <span>alexbalan@example.com</span>
       </div>
    ...
    <nav class="mdl-navigation mdl-color-text--blue-grey-300">
        ...
        <a class="mdl-navigation__link mdl-color-text--blue-grey-300" href="/project1/browse-books.php?state=reset"><i class="material-icons" role="presentation">event</i> Books</a>
        ...
        <a class="mdl-navigation__link mdl-color-text--blue-grey-300" href=""><i class="material-icons" role="presentation">settings</i> Analytics</a>
